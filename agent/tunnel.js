// PC Control Remote Tunnel Launcher
// Creates a secure public Cloudflare Tunnel for PC Control Agent to allow remote sleep/restart/shutdown from anywhere.
...
async function run() {
  console.log('================================================================');
  console.log('🌐 Starting PC Control Agent + Secure Cloudflare Remote Tunnel...');
  console.log('================================================================');
  ...
  try {
    ...
    console.log('\n📋 INSTRUCTIONS:');
    console.log('1. Open your PC Control Dashboard on any device (phone, laptop, iPad).');
    console.log('2. Go to Settings -> PC Power & Webhooks.');
    console.log(`3. Paste "${tunnelUrl}" into "Remote PC Agent URL".`);
